                ...
                <div class="row">
                  <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    ...
                    <div class="card card-primary">
                      ...
                      <form action="../guest/pasien.php" method="POST">
                      <button type="submit" name="guest" class="btn btn-primary btn-lg btn-block" tabindex="4">
                        Login As Guest
                      </button>
                    </form>
                    </div>
                  ...
                  <div class="simple-footer">
                    Copyright &copy; Rekam Medis 2021
                  </div>
                </div>
              </div>
            </div>
